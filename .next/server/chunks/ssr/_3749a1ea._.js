module.exports=[40018,a=>{"use strict";let b=a=>{let b=(.5*a.amount).toFixed(2),c=(.5*a.amount).toFixed(2);return`
<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8">
