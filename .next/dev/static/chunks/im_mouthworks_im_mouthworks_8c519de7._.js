...
function LoginScreen() {
    ...
    const handleRegister = async (e)=>{
        ...
        setLoading(true);
        try {
            const res = await register(email, password, regName, regPhone || undefined);
            if (res && res.status === "exists") {
                setError("User with this email already exists. Please sign in instead.");
                setShowRegister(false);
            } else {
                // after registering, navigate to patient dashboard
                router.push("/patient/dashboard");
            }
        } catch (err) {
...
//# sourceMappingURL=im_mouthworks_im_mouthworks_8c519de7._.js.map